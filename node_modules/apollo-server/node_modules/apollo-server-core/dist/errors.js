...
function formatApolloErrors(errors, options) {
    ...
    errors.forEach(function (error) {
        if (Array.isArray(error.errors)) {
            error.errors.forEach(function (e) { return flattenedErrors.push(e); });
        }
        else if (error.originalError &&
            Array.isArray(error.originalError.errors)) {
            error.originalError.errors.forEach(function (e) { return flattenedErrors.push(e); });
        }
        else {
            flattenedErrors.push(error);
        }
    });
    var enrichedErrors = flattenedErrors.map(function (error) {
        return enrichError(error, debug);
    });
    if (!formatter) {
