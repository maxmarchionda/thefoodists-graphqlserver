...
var EngineReportingAgent = /** @class */ (function () {
    function EngineReportingAgent(options) {
        ...
        this.resetReport();
        this.reportTimer = setInterval(function () { return _this.sendReport(); }, this.options.reportIntervalMs || 10 * 1000);
                ...
                process.once(signal, function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                this.stop();
                                return [4 /*yield*/, this.sendReport()];
                            case 1:
                                _a.sent();
    ...
    EngineReportingAgent.prototype.addTrace = function (signature, operationName, trace) {
        ...
        if (this.traceCount * this.averageTraceSize >=
    ...
    EngineReportingAgent.prototype.sendReport = function () {
        ...
        var traceCount = this.traceCount;
        this.resetReport();
        ...
        return Promise.resolve()
            ...
            var averageTraceSizeThisReport = message.length / traceCount;
            ...
            var alpha = 0.9;
            _this.averageTraceSize =
                alpha * averageTraceSizeThisReport +
                    (1 - alpha) * _this.averageTraceSize;
